...
#define MOTOR_DECELE_RATIO (1.0f / 10.0f)//(1.0f / 19.0f)
/* single 3508 motor maximum speed, unit is rpm */
#define MAX_WHEEL_RPM 2000 // 8500 //8347rpm = 3500mm/s
/* chassis maximum translation speed, unit is mm/s */
#define MAX_CHASSIS_VX_SPEED 1500 // 3300 //8000rpm
#define MAX_CHASSIS_VY_SPEED 1500 //3300
/* chassis maximum rotation speed, unit is degree/s */
#define MAX_CHASSIS_VW_SPEED 150 //300 //5000rpm
